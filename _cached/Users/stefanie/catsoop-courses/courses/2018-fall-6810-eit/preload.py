...
#     #                                 ]},
#     {'text': 'Group Project', 'link': [
#                                     {'text': 'Topic', 'link':'COURSE/group-project-topic'},
#                                     {'text': 'Deliverables & Timeline', 'link':'COURSE/group-project-deliverables-and-timeline'},
#                                     # {'text': 'Timeline', 'link':'COURSE/group-project-timeline'},
#                                     {'text': 'Buying Materials', 'link':'COURSE/group-project-buying-materials'},
#                                     {'text': 'Team Folders', 'link':'COURSE/group-project-team-folder'},
#                                     ]},


#     {'text': 'Homework', 'link': [{'text': 'Lasercut Businesscard (Due: 9/26/2018)', 'link': 'COURSE/hw-lasercut-business-card'},
#                                       ]},
#     {'text': 'Fabrication Tutorials', 'link': [
#                               {'text': 'How to Lasercut', 'link': 'COURSE/fabrication-laser-cutting'},
#                               {'text': 'How to 3D Print', 'link': 'COURSE/fabrication-3d-printing'},
#                                     ]},
#     {'text': 'Presentation Tutorials', 'link': [
#                               {'text': 'Setting Up Website', 'link': 'COURSE/presentation-setup-website'},
#                               {'text': 'Project Proposal', 'link': 'COURSE/presentation-project-proposal'},
#                               {'text': 'Drawing Rotoscopes', 'link': 'COURSE/presentation-drawing-rotoscopes'},
#                               {'text': 'Taking Photos', 'link': 'COURSE/presentation-taking-photos'},
#                               {'text': 'Photo Editing', 'link': 'COURSE/presentation-photo-editing'},
#                               {'text': 'Taking Videos', 'link': 'COURSE/presentation-video-editing'},
#                               {'text': 'Video Editing', 'link': 'COURSE/presentation-video-editing'},
#                                     ]}
# ]
