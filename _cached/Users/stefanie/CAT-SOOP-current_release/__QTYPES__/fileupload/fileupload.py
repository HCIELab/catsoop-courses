import sys
_orig_path = sys.path
if '/Users/stefanie/CAT-SOOP-current_release/__QTYPES__/fileupload' not in sys.path:
    sys.path = ['/Users/stefanie/CAT-SOOP-current_release/__QTYPES__/fileupload'] + sys.path
...
base, _ = tutor.question(globals(),"smallbox")
