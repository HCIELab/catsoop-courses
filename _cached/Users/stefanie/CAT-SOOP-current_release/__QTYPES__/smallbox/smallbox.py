import sys
_orig_path = sys.path
if '/Users/stefanie/CAT-SOOP-current_release/__QTYPES__/smallbox' not in sys.path:
    sys.path = ['/Users/stefanie/CAT-SOOP-current_release/__QTYPES__/smallbox'] + sys.path
